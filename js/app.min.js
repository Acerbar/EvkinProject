...
document.addEventListener("click", function (event) {
    ...
    if (event.target.closest('.popup-open') || event.target.closest('.popup-open-mobile')) {
        popUpMap.classList.add("popup__map_open");
        (event).preventDefault();
    }
    else if (target != popUpContent) {
        popUpMap.classList.remove("popup__map_open")
    }
})
...
const burgerServicesSublist = document.getElementById('services-sublist');
const burgerWhyWeSublist = document.getElementById('why-we-sublist');
const body = document.body;
document.addEventListener('click', function (event) {
    if (event.target.closest('.burger__icon')) {
        burger.classList.toggle('burger__active');
        burgerNav.classList.toggle('burger__visible');
        body.classList.toggle('locked');
        burgerServicesSublist.classList.remove("burger__sublist_active");
        burgerWhyWeSublist.classList.remove("burger__sublist_active");
    }
    else if (event.target.closest('#services')) {
        burgerServicesSublist.classList.toggle("burger__sublist_active");

    }
    else if (event.target.closest('#why-we')){
        burgerWhyWeSublist.classList.toggle("burger__sublist_active");
    }
    else if (!event.target.closest('.burger__menu')) {
        burger.classList.remove('burger__active');
        burgerNav.classList.remove('burger__visible');
